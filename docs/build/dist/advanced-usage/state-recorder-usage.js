...
export let StateRecorderUsage = _decorate([customElement('state-recorder-usage')], function (_initialize, _LitDocsContent) {
  class StateRecorderUsage extends _LitDocsContent {
    constructor(...args) {
      super(...args);
