...
import { LitState, stateVar, StateVar } from '../../lit-state.js';

class LocalStorageHandler extends StateVar {
  constructor(args) {
    super(args);
    this.value = localStorage.getItem(this.options.localStorageKey) || this.options.initialValue;
  }
...
let DemoState = _decorate(null, function (_initialize, _LitState) {
  ...
  return {
    ...
    d: [{
      kind: "field",
      decorators: [localStorageStateVar({
