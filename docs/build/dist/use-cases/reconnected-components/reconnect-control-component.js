...
export let ReconnectControlComponent = _decorate([customElement('reconnect-control-component')], function (_initialize, _observeState) {
  class ReconnectControlComponent extends _observeState {
    constructor(...args) {
      super(...args);
