...
import './reconnecting-component.js';
import './reconnect-control-component.js';
export let ReconnectedComponents = _decorate([customElement('reconnected-components')], function (_initialize, _LitDocsContent) {
  class ReconnectedComponents extends _LitDocsContent {
    constructor(...args) {
      super(...args);
  ...
  return {
    F: ReconnectedComponents,
    d: [{
      kind: "method",
      key: "firstUpdated",
      value: function firstUpdated() {
        _get(_getPrototypeOf(ReconnectedComponents.prototype), "firstUpdated", this).call(this);

        this.initConnectionCallback();
      }
    }, {
      kind: "method",
      key: "initConnectionCallback",
      value: function initConnectionCallback() {
      ...
      kind: "method",
      key: "initReconnectingComponentConnection",
      value: function initReconnectingComponentConnection() {
