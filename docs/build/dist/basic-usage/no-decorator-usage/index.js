...
export let NoDecoratorUsage = _decorate([customElement('no-decorator-usage')], function (_initialize, _LitDocsContent) {
  class NoDecoratorUsage extends _LitDocsContent {
    constructor(...args) {
      super(...args);
