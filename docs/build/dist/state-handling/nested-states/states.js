...
let ParentState = _decorate(null, function (_initialize, _LitState) {
  class ParentState extends _LitState {
    constructor(...args) {
      super(...args);
...
let ChildState = _decorate(null, function (_initialize2, _LitState2) {
  class ChildState extends _LitState2 {
    constructor(...args) {
      super(...args);
