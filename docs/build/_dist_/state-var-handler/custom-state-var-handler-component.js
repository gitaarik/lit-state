...
export let CustomStateVarHandlerComponent = _decorate([customElement('custom-state-var-handler-component')], function (_initialize, _observeState) {
  class CustomStateVarHandlerComponent extends _observeState {
    constructor(...args) {
      super(...args);
  ...
  return {
    F: CustomStateVarHandlerComponent,
    d: [{
      kind: "method",
      key: "render",
      ...
      kind: "method",
      key: "handleDecreaseCounterButtonClick",
      value: function handleDecreaseCounterButtonClick() {
        demoState.counter--;
      }
    }, {
      kind: "method",
