...
export let NestedStateComponent = _decorate([customElement('nested-state-component')], function (_initialize, _observeState) {
  ...
  return {
    ...
    d: [{
      ...
      kind: "method",
      key: "handleIncreaseChild1CounterButtonClick",
      value: function handleIncreaseChild1CounterButtonClick() {
        parentState.childState1.counter++;
      }
    }, {
      kind: "method",
      key: "handleIncreaseChild2CounterButtonClick",
      value: function handleIncreaseChild2CounterButtonClick() {
