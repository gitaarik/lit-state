...
export let AsyncUpdateCacheComponent2 = _decorate([customElement('async-update-cache-component-2')], function (_initialize, _LitStateElement) {
  class AsyncUpdateCacheComponent2 extends _LitStateElement {
    constructor(...args) {
      super(...args);
