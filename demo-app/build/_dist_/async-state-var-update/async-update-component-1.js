...
export let AsyncUpdateComponent1 = _decorate([customElement('async-update-component-1')], function (_initialize, _LitStateElement) {
  class AsyncUpdateComponent1 extends _LitStateElement {
    constructor(...args) {
      super(...args);
