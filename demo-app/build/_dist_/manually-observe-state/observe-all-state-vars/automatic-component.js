...
export let AutomaticComponent = _decorate([customElement('automatic-component')], function (_initialize, _observeState) {
  class AutomaticComponent extends _observeState {
    constructor(...args) {
      super(...args);
